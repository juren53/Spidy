"""
Spidy - A Simple Web Browser

This module implements a web browser application built with PyQt5 and QtWebEngine.
It provides basic browsing functionality, bookmarks, history tracking, and statistics.
The browser handles various URL schemes and security considerations.
"""
...
# Qt core imports - must be imported and configured before any other Qt components
...
QtCore.QCoreApplication.setAttribute(
    Qt.AA_DontCreateNativeWidgetSiblings, True)  # Prevents QQuickWidget warnings
QtCore.QCoreApplication.setAttribute(
    Qt.AA_DisableHighDpiScaling, True)  # Disables high DPI scaling
QtCore.QCoreApplication.setAttribute(
    Qt.AA_ShareOpenGLContexts, True)  # Enables sharing of OpenGL contexts
QtCore.QCoreApplication.setAttribute(
    Qt.AA_UseSoftwareOpenGL, True)  # Use software OpenGL if available

# Initialize QtWebEngine before importing QtWebEngineWidgets
from PyQt5.QtWebEngine import QtWebEngine
QtWebEngine.initialize()

# Web engine components - must be imported after QtWebEngine initialization
from PyQt5.QtWebEngineWidgets import (
    QWebEngineView, QWebEnginePage, QWebEngineSettings, QWebEngineProfile
)

# QApplication must be created after QtWebEngine initialization but before other widgets
from PyQt5.QtWidgets import QApplication
app = QApplication(sys.argv)

# Remaining Qt components - safe to import after QApplication is created
from PyQt5.QtCore import QUrl, QDateTime, QSize
from PyQt5.QtGui import QKeySequence, QIcon

# UI widget imports
from PyQt5.QtWidgets import (
    QLineEdit, QPushButton, QVBoxLayout, QHBoxLayout, QWidget, QAction,
    QMainWindow, QDialog, QTableWidget, QTableWidgetItem, QHeaderView, QDialogButtonBox,
    QFileDialog, QMessageBox, QLabel, QGridLayout, QTabWidget, QShortcut)
...
class Browser(QMainWindow):
    ...
    def initUI(self):
        ...
        self.setWindowIcon(QIcon('ICON_spidy.jpeg'))
    ...
    def add_new_tab(self, qurl=None):
        ...
        browser.titleChanged.connect(lambda title, b=browser: self.update_history_title(title, b))
